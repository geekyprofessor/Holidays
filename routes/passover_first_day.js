...
var metadata = {
  ...
  Religion: "Jewish", //could be "Christian", "Jewish", "Orthodox", "Muslim", "Hindu" or undefined
  AlternateNames: ["Pesach", "Season Of Our Freedom", "Holiday of Mazot"] //may contain alternate names for the holiday - for example for Mardi Gras, altername names would be ["Fat Tuesday", "Shrove Tuesday"]
};
...
router.get('/:year', function(req, res, next) {
  //calculate holiday date here according to lunar date
  var date = moment(new Date(req.params.year, 3, 1)); //set date to 1st of June
