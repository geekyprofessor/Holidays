...
var metadata = {
  ...
  AlternateNames: ["Holocaust Remembrance Day"] //may contain alternate names for the holiday - for example for Mardi Gras, altername names would be ["Fat Tuesday", "Shrove Tuesday"]
};
...
router.get('/:year', function(req, res, next) {
  ...
  var date = moment(new Date(req.params.year, 10, 1)); //set date to 1st of November
  //Target Thursday on 4th Week
  var weekOfMonth = 4;	// 4th Week 
  var dayOfWeek = 2;	// Thursday
