...
var metadata = {
  ...
  AlternateNames: ["Feast of Saint Patrick"] //may contain alternate names for the holiday - for example for Mardi Gras, altername names would be ["Fat Tuesday", "Shrove Tuesday"]
};
...
router.get('/:year', function(req, res, next) {
  ...
  var dt = new Date(req.params.year, 2, 17); //note: when setting month, 0 = January, 11 = December. 
