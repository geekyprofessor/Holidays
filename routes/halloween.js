...
var metadata = {
  ...
  AlternateNames: ["All Hallows Eve", "All Saints Eve" ] //may contain alternate names for the holiday - for example for Mardi Gras, altername names would be ["Fat Tuesday", "Shrove Tuesday"]
};
...
router.get('/:year', function(req, res, next) {
    ...
    var dt = new Date(req.params.year, 9, 31); 
