...
var metadata = {
  ...
  Religion: Orthodox, //could be "Christian", "Jewish", "Orthodox", "Muslim", "Hindu" or undefined
  AlternateNames: ["Old New Year" ] //may contain alternate names for the holiday - for example for Mardi Gras, altername names would be ["Fat Tuesday", "Shrove Tuesday"]
};
...
router.get('/:year', function(req, res, next) {
    ...
    var dt = new Date(req.params.year, 00, 14); 
