...
router.get('/:year', function(req, res, next) {
  ...
  var dt = new Date(req.params.year, 0, 21 ); //note: when setting month, 0 = January, 11 = December. 
  ...
  var rtrn = { 
    ...
    Month : dt.getMonth(0) + 1, //returns 1-12
    Day: dt.getDate(21), 
    Year: dt.getFullYear(2019), 
    DayOfWeek: dt.getDay(1), //returns 0-6
